    ...
    def self.all
      [
        Row.new(id: "s-1", name: "Valentina Suárez", student_code: "COL-E-101", status: "active",
                group_id: GroupManagement::GroupRoster::SECTION_9A_ID, group_name: "9°A", grade_level_name: "Grado 9",
        ...
        Row.new(id: "s-4", name: "Mateo Cárdenas", student_code: "COL-E-104", status: "active",
                group_id: GroupManagement::GroupRoster::SECTION_10A_ID, group_name: "10°A", grade_level_name: "Grado 10",
        ...
        Row.new(id: "s-7", name: "Daniela Ortiz", student_code: "COL-E-107", status: "active",
                group_id: GroupManagement::GroupRoster::SECTION_11B_ID, group_name: "11°B", grade_level_name: "Grado 11",
