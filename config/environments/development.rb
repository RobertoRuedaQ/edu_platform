...
Rails.application.configure do
  ...
  # Multi-tenant subdomain login (TenantScoped resolves the institution from
  # request.subdomain) needs a real hostname in dev — lvh.me resolves any
  # subdomain to 127.0.0.1, but it's a real public domain so Rails' default
  # HostAuthorization list (localhost/.localhost/IPs) blocks it otherwise.
  config.hosts << /.*\.lvh\.me/
end
